...
if __name__ == '__main__':
     ...
     testing_output = ('outputs_testDQN/scenario6/testing_output_dqn_scenario6_gamma0.25.txt')
     output_statistics_file = ('outputs_testDQN/scenario6/output_statistics_dqn_scenario6_gamma0.25.txt')

     csp_i_scenario6_output_file = ('outputs_testDQN/scenario6/csp_i_dqn_scenario6_gamma0.25.txt')
     csp_m_scenario6_output_file = ('outputs_testDQN/scenario6/csp_m_dqn_scenario6_gamma0.25.txt')
     movable_rewards_scenario6_output_file = ('outputs_testDQN/scenario6/cumrewards_movable_scenario6_gamma0.25.txt')
     immovable_rewards_scenario6_output_file = ('outputs_testDQN/scenario6/cumrewards_immovable_scenario6_gamma0.25.txt')
     schedule_score_scenario6_output_file = ('outputs_testDQN/scenario6/schedule_score_scenario6_gamma0.25.txt')

     average_immovable_loss_history_scenario6_output_file = ('outputs_testDQN/scenario6/'
                                                             'average_immovable_loss_history_scenario6_gamma0.25.txt')
     average_movable_loss_history_scenario6_output_file = ('outputs_testDQN/scenario6/'
