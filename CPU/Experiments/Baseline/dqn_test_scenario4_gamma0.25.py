...
if __name__ == '__main__':
     ...
     testing_output = ('outputs_testDQN/scenario4/testing_output_dqn_scenario4_gamma0.25.txt')
     output_statistics_file = ('outputs_testDQN/scenario4/output_statistics_dqn_scenario4_gamma0.25.txt')

     csp_i_scenario4_output_file = ('outputs_testDQN/scenario4/csp_i_dqn_scenario4_gamma0.25.txt')
     csp_m_scenario4_output_file = ('outputs_testDQN/scenario4/csp_m_dqn_scenario4_gamma0.25.txt')
     movable_rewards_scenario4_output_file = ('outputs_testDQN/scenario4/cumrewards_movable_scenario4_gamma0.25.txt')
     immovable_rewards_scenario4_output_file = ('outputs_testDQN/scenario4/cumrewards_immovable_scenario4_gamma0.25.txt')
     schedule_score_scenario4_output_file = ('outputs_testDQN/scenario4/schedule_score_scenario4_gamma0.25.txt')

     average_immovable_loss_history_scenario4_output_file = ('outputs_testDQN/scenario4/'
                                                             'average_immovable_loss_history_scenario4_gamma0.25.txt')
     average_movable_loss_history_scenario4_output_file = ('outputs_testDQN/scenario4/'
