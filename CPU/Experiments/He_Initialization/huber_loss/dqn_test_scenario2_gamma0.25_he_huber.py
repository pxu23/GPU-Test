...
if __name__ == '__main__':
     ...
     testing_output = ('outputs_testDQN_he_huber/scenario2/testing_output_dqn_scenario2_gamma0.25.txt')
     output_statistics_file = ('outputs_testDQN_he_huber/scenario2/output_statistics_dqn_scenario2_gamma0.25.txt')

     csp_i_scenario2_output_file = ('outputs_testDQN_he_huber/scenario2/csp_i_dqn_scenario2_gamma0.25.txt')
     csp_m_scenario2_output_file = ('outputs_testDQN_he_huber/scenario2/csp_m_dqn_scenario2_gamma0.25.txt')
     movable_rewards_scenario2_output_file = ('outputs_testDQN_he_huber/scenario2/cumrewards_movable_scenario2_gamma0.25.txt')
     immovable_rewards_scenario2_output_file = ('outputs_testDQN_he_huber/scenario2/cumrewards_immovable_scenario2_gamma0.25.txt')
     schedule_score_scenario2_output_file = ('outputs_testDQN_he_huber/scenario2/schedule_score_scenario2_gamma0.25.txt')

     average_immovable_loss_history_scenario2_output_file = ('outputs_testDQN_he_huber/scenario2/'
                                                             'average_immovable_loss_history_scenario2_gamma0.25.txt')
     average_movable_loss_history_scenario2_output_file = ('outputs_testDQN_he_huber/scenario2/'
