...
if __name__ == '__main__':
     ...
     testing_output = ('outputs_testDQN_he_huber/scenario3/testing_output_dqn_scenario3_gamma0.25.txt')
     output_statistics_file = ('outputs_testDQN_he_huber/scenario3/output_statistics_dqn_scenario3_gamma0.25.txt')
     csp_i_scenario3_output_file = ('outputs_testDQN_he_huber/scenario3/csp_i_dqn_scenario3_gamma0.25.txt')
     csp_m_scenario3_output_file = ('outputs_testDQN_he_huber/scenario3/csp_m_dqn_scenario3_gamma0.25.txt')
     movable_rewards_scenario3_output_file = ('outputs_testDQN_he_huber/scenario3/cumrewards_movable_scenario3_gamma0.25.txt')
     immovable_rewards_scenario3_output_file = ('outputs_testDQN_he_huber/scenario3/cumrewards_immovable_scenario3_gamma0.25.txt')
     schedule_score_scenario3_output_file = ('outputs_testDQN_he_huber/scenario3/schedule_score_scenario3_gamma0.25.txt')

     average_immovable_loss_history_scenario3_output_file = ('outputs_testDQN_he_huber/scenario3/'
                                                             'average_immovable_loss_history_scenario3_gamma0.25.txt')
     average_movable_loss_history_scenario3_output_file = ('outputs_testDQN_he_huber/scenario3/'
                                                           'average_movable_loss_history_scenario3_gamma0.25.txt')

     performSimulation(immovable_constraint_list, movable_constraint_list, 4,
                       ...
                       output_file_rewards_immovable=immovable_rewards_scenario3_output_file,
                       output_file_rewards_movable=movable_rewards_scenario3_output_file,
                       output_file_csp_i=csp_i_scenario3_output_file,
                       output_file_csp_m=csp_m_scenario3_output_file,
                       output_file_schedule_score=schedule_score_scenario3_output_file,
                       output_file_average_immovable_loss_history=average_immovable_loss_history_scenario3_output_file,
                       output_file_average_movable_loss_history=average_movable_loss_history_scenario3_output_file)
