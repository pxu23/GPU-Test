...
if __name__ == '__main__':
     ...
     testing_output = ('outputs_testDQN_he_mse/scenario5/testing_output_dqn_scenario5_gamma0.25.txt')
     output_statistics_file = ('outputs_testDQN_he_mse/scenario5/output_statistics_dqn_scenario5_gamma0.25.txt')

     csp_i_scenario5_output_file = ('outputs_testDQN_he_mse/scenario5/csp_i_dqn_scenario5_gamma0.25.txt')
     csp_m_scenario5_output_file = ('outputs_testDQN_he_mse/scenario5/csp_m_dqn_scenario5_gamma0.25.txt')
     movable_rewards_scenario5_output_file = ('outputs_testDQN_he_mse/scenario5/cumrewards_movable_scenario5_gamma0.25.txt')
     immovable_rewards_scenario5_output_file = ('outputs_testDQN_he_mse/scenario5/cumrewards_immovable_scenario5_gamma0.25.txt')
     schedule_score_scenario5_output_file = ('outputs_testDQN_he_mse/scenario5/schedule_score_scenario5_gamma0.25.txt')

     average_immovable_loss_history_scenario5_output_file = ('outputs_testDQN_he_mse/scenario5/'
                                                             'average_immovable_loss_history_scenario5_gamma0.25.txt')
     average_movable_loss_history_scenario5_output_file = ('outputs_testDQN_he_mse/scenario5/'
