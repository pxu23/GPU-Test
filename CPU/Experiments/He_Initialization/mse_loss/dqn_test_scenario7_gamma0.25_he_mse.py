...
if __name__ == '__main__':
     ...
     testing_output = ('outputs_testDQN_he_mse/scenario7/testing_output_dqn_scenario7_gamma0.25.txt')
     output_statistics_file = ('outputs_testDQN_he_mse/scenario7/output_statistics_dqn_scenario7_gamma0.25.txt')
     csp_i_scenario7_output_file = ('outputs_testDQN_he_mse/scenario7/csp_i_dqn_scenario7_gamma0.25.txt')
     csp_m_scenario7_output_file = ('outputs_testDQN_he_mse/scenario7/csp_m_dqn_scenario7_gamma0.25.txt')
     movable_rewards_scenario7_output_file = ('outputs_testDQN_he_mse/scenario7/cumrewards_movable_scenario7_gamma0.25.txt')
     immovable_rewards_scenario7_output_file = ('outputs_testDQN_he_mse/scenario7/cumrewards_immovable_scenario7_gamma0.25.txt')
     schedule_score_scenario7_output_file = ('outputs_testDQN_he_mse/scenario7/schedule_score_scenario7_gamma0.25.txt')

     average_immovable_loss_history_scenario7_output_file = ('outputs_testDQN_he_mse/scenario7/'
                                                             'average_immovable_loss_history_scenario7_gamma0.25.txt')
     average_movable_loss_history_scenario7_output_file = ('outputs_testDQN_he_mse/scenario7/'
