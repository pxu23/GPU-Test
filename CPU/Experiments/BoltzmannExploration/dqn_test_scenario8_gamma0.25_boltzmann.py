...
if __name__ == '__main__':
     ...
     testing_output = ('outputs_testDQN_Boltzmann/scenario8/testing_output_dqn_scenario8_gamma0.25.txt')
     output_statistics_file = ('outputs_testDQN_Boltzmann/scenario8/output_statistics_dqn_scenario8_gamma0.25.txt')
     csp_i_scenario8_output_file = ('outputs_testDQN_Boltzmann/scenario8/csp_i_dqn_scenario8_gamma0.25.txt')
     csp_m_scenario8_output_file = ('outputs_testDQN_Boltzmann/scenario8/csp_m_dqn_scenario8_gamma0.25.txt')
     movable_rewards_scenario8_output_file = ('outputs_testDQN_Boltzmann/scenario8/cumrewards_movable_scenario8_gamma0.25.txt')
     immovable_rewards_scenario8_output_file = ('outputs_testDQN_Boltzmann/scenario8/cumrewards_immovable_scenario8_gamma0.25.txt')
     schedule_score_scenario8_output_file = ('outputs_testDQN_Boltzmann/scenario8/schedule_score_scenario8_gamma0.25.txt')

     average_immovable_loss_history_scenario8_output_file = ('outputs_testDQN_Boltzmann/scenario8/'
                                                             'average_immovable_loss_history_scenario8_gamma0.25.txt')
     average_movable_loss_history_scenario8_output_file = ('outputs_testDQN_Boltzmann/scenario8/'
