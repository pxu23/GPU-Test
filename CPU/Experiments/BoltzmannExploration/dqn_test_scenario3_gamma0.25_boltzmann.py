...
if __name__ == '__main__':
     ...
     testing_output = ('outputs_testDQN_Boltzmann/scenario3/testing_output_dqn_scenario3_gamma0.25.txt')
     output_statistics_file = ('outputs_testDQN_Boltzmann/scenario3/output_statistics_dqn_scenario3_gamma0.25.txt')
     csp_i_scenario3_output_file = ('outputs_testDQN_Boltzmann/scenario3/csp_i_dqn_scenario3_gamma0.25.txt')
     csp_m_scenario3_output_file = ('outputs_testDQN_Boltzmann/scenario3/csp_m_dqn_scenario3_gamma0.25.txt')
     movable_rewards_scenario3_output_file = ('outputs_testDQN_Boltzmann/scenario3/cumrewards_movable_scenario3_gamma0.25.txt')
     immovable_rewards_scenario3_output_file = ('outputs_testDQN_Boltzmann/scenario3/cumrewards_immovable_scenario3_gamma0.25.txt')
     schedule_score_scenario3_output_file = ('outputs_testDQN_Boltzmann/scenario3/schedule_score_scenario3_gamma0.25.txt')

     average_immovable_loss_history_scenario3_output_file = ('outputs_testDQN_Boltzmann/scenario3/'
                                                             'average_immovable_loss_history_scenario3_gamma0.25.txt')
     average_movable_loss_history_scenario3_output_file = ('outputs_testDQN_Boltzmann/scenario3/'
